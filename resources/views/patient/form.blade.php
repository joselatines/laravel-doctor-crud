<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            {!! $errors->first('name', '<div class="invalid-feedback" role="alert"><strong>Un nombre es requerido</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            ...
            {!! $errors->first('last_name', '<div class="invalid-feedback" role="alert"><strong>Un apellido es requerido</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            ...
            {!! $errors->first('email', '<div class="invalid-feedback" role="alert"><strong>Un correo valido es requerido</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="note" class="form-label">{{ __('Nota') }}</label>
            <input type="text" name="note" class="form-control @error('note') is-invalid @enderror" value="{{ old('note', $patient?->note ?? 'Sin nota') }}" id="note" placeholder="Posee antecedentes familiares">
            {!! $errors->first('note', '<div class="invalid-feedback" role="alert"><strong>Una nota es requerida</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            ...
            {!! $errors->first('age', '<div class="invalid-feedback" role="alert"><strong>Una edad es requerida</strong></div>') !!}
        </div>
